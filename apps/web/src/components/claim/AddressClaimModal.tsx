...
import getTokenLogo from "../../utils1/getTokenLogo";
...
import { getEtherscanLink, shortenAddress } from "../../utils1";
        ...
        <ContentWrapper gap="lg">
          ...
          >
            <TYPE.subHeader fontWeight={500}>
              Enter an address to trigger a {govToken?.symbol} claim. If the
              address has any claimable {govToken?.symbol}
