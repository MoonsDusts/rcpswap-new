...
export const SUPPORTED_CONNECTORS: {
  [key: string]: { image: StaticImageData; color: string; href: string | null, description: string | null };
} = {
  injected: {
    image: InjectedIcon,
    color: "#010101",
  ...
  metaMask: { image: MetamaskIcon, color: "#E8831D", href: null, description: 'Easy-to-use browser extension.' },
  coinbaseWallet: {
    image: CoinbaseIcon,
    color: "#315CF5",
    href: null,
  ...
  walletConnect: {
    image: WalletConnectIcon, color: "#4196FC", href: null,
    description: 'Use Coinbase Wallet app on mobile device',
  },
  ledger: { image: LedgerIcon, color: "#fafafa", href: null, description: 'Hardware & Cold Wallet.' },
};
